...
import br.ufpb.iged.grafico.geometria.Circulo;
...
public class NodeTree extends Node {
    ...
    public NodeTree(Point2D pb, Quadro q) {
        super(q);
        super.setPoint(pb);
    ...
    public void setTracoLeftChield(Point2D ppe) {
        Traco spe = new Traco(this.pe, new Point2D.Double(ppe.getX(), ppe.getY() - 4), false, quadro);
    ...
    public void setTracoRightChield(Point2D ppd) {
        Traco spd = new Traco(this.pd, new Point2D.Double(ppd.getX(), ppd.getY() - 4), false, quadro);
    ...
    public void clearTracoRightChield() {
        if (this.tracoRightChield != null) {
            ...
            quadro.remove(this.tracoRightChield);
    ...
    public void clearTracoLeftChield() {
        if (this.tracoLeftChield != null) {
            ...
            quadro.remove(this.tracoLeftChield);
    ...
    public void setRightChield(NodeTree nt) {
        ...
        this.rightChield = nt;
        this.tracoRightChield = new Traco(this.pd, nt.getPP(), false, quadro);
        this.elementos.add(this.tracoRightChield);
        quadro.add(this.tracoRightChield);
        quadro.atualizar();
    ...
    public void setLeftChield(NodeTree nt) {
        ...
        this.leftChield = nt;
        this.tracoLeftChield = new Traco(this.pe, nt.getPP(), false, quadro);
        this.elementos.add(this.tracoLeftChield);
        quadro.add(this.tracoLeftChield);
        quadro.atualizar();
...
//		NodeTree nt = this;
    ...
    public void setValue(String v) {
        ...
        this.circ.evidencia(Color.red, 4, quadro);
