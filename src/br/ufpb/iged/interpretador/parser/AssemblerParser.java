// $ANTLR 3.4 C:\\Users\\Tiago\\Git\\IGED\\IGED\\src\\br\\ufpb\\iged\\interpretador\\gramaticas\\Assembler.g 2013-05-01 17:32:30
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final AssemblerParser.definicaoClasse_return definicaoClasse() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ID, membroClasse, superClasse, 36
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt17) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: limite, parametros, ret, operacao, INIT
                    // token labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: parametros, ID, limite, operacao, ret
                    // token labels: 
                    // rule labels: ret, retval
                    // token list labels: 
                    // rule list labels: 
