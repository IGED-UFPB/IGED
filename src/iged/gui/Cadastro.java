...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botaoSelecionar.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                } catch (iged.gui.CampoObrigatorioException ex) {
   ...
   ConversorXmlTutorial cXml = new ConversorXmlTutorial();
    ...
    private void botaoOkActionPerformed(java.awt.event.ActionEvent evt) throws iged.gui.CampoObrigatorioException, DiretorioExistenteException, CampoInvalidoException {
        Object[] opcoes = {"Sim", "Não"};
